...
ActiveRecord::Schema[7.0].define(version: 2023_10_01_154820) do
  ...
  create_table "kit_books", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "budget_price", default: {"tipo 1"=>1500, "tipo 2"=>2500, "tipo 3"=>5000}
  ...
  create_table "printing_prices", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "santa_marta_price"
    t.decimal "pancron_price"
